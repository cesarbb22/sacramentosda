                ...
                $.ajax({
                    ...
                    success: function(data) {
                        if (data.length > 0) {
                            ...
                            btn.setAttribute("href", "/DetalleUsuario/" + data[0].IDPersona);
        ...
        function ajaxCall() {
            ...
            $.ajax({
                ...
                success: function(data) {
                    $('#miTabla').empty();
                    var content = "";
                    content = "<thead><tr><th>Parroquia que notifica</th><th>Fecha de Aviso</th><th>Sacramento</th><th>Estado</th><th>Información Adicional</th><th>Ver partida</th><th>Finalizar</th></tr></thead><tbody>"
                    if (isTipoEnviado) {
                        content = "<thead><tr><th>Parroquia a la que se notifica</th><th>Fecha de Aviso</th><th>Sacramento</th><th>Estado</th><th>Información Adicional</th><th>Ver partida</th><th>Finalizar</th></tr></thead><tbody>"
                    }
                    ...
                    for(i=0; i<data.length; i++){
                        ...
                        content += '<tr>'
                            ...
                            content += '<td><a class="desc" target="_blank" href="DetalleUsuario/'+data[i].acta.IDPersona+'"><i class="material-icons">description</i></a></td>';
                        if (!isTipoEnviado) {
