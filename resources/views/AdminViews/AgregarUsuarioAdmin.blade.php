            ...
            <div class="card-panel z-depth-4">
                ...
                <form class="form-horizontal" role="form" method="POST" action="/crearUsuario">
                    ...
                    <div class="form-group{{ $errors->has('name') ? ' has-error' : '' }}">
                        ...
                        <div class="col-md-6">
                            <input id="pApellido" type="text" class="form-control" name="pApellido"
                    ...
                    <div class="form-group{{ $errors->has('name') ? ' has-error' : '' }}">
                        ...
                        <div class="col-md-6">
                            <input id="sApellido" type="text" class="form-control" name="sApellido"
                                   value="{{ old('name') }}" required autofocus>
                    ...
                    <div class=row>
                        ...
                        <div class="form-group">
                            <button id="guardar" class="waves-effect waves-light btn right" type="submit"><i
